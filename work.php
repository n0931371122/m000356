    ...
    <script type="application/ld+json">
        {
            ...
            "@graph": [{
                "@type": "Article",
                "headline": "綠色能源成為社區助力，環境友善工法，永續在地深耕",
                "image": "styles/images/works/1.jpg"
            }]
        }
    </script>
</head>
                ...
                <div class="position-relative px-4">
                    <div class="max1302 mx-auto pb-md-3 pb-lg-5 mb-xl-4">
                        ...
                        <div class="editor" id="workEditor">
                            ...
                            <div class="mb-5">
                                <h2 class="font-24 font-weight-bold les1 mb-3 mb-md-4" data-aos="fade-up">永續潔能與環境友善，在地深耕、活絡地方經濟</h2>
                            ...
                            <div>
                                <h2 class="font-24 font-weight-bold les1 mb-3 mb-md-4" data-aos="fade-up">力行植生復育 多元物種豐富在地生態，永續潔能與環境友善，強化水土保持保護效果</h2>
                                <p data-aos="fade-up">案場內部分區域，在植生復育上已有初步成果，而各區域也因地理環境、生態豐富以及水土保持性等考量而選用不同的植生項目，包括灑草籽、厚植生、植樹苗等，預計植栽的樹種包含相思樹、光臘樹與茄冬樹等。而針對區域範圍，撒播草籽如錢幣草、鳳尾蕨、竹葉草、棕葉狗尾草、黑麥草等植物，恢復植生覆蓋，並達到強化水土保持保護效果。</p>
                            </div>
                            <figure class="d-table mx-auto my-md-3 my-xl-5 py-3" data-aos="fade-up">
                                <img class="mb-3" src="styles/images/work/2.jpg" alt="">
                                <figcaption class="text-707070">圖一：近年面臨極端氣候之威脅及能源耗竭之挑戰積極發展，應用成為帶動產業發展的主要動力 (此為照片備註文字)</figcaption>
                            </figure>
                            <div>
                            ...
                            <div class="row mb-4">
                                <div class="col-12 col-md-6">
                                    <figure class="d-table mx-auto my-md-3 my-xl-5 py-3" data-aos="fade-up">
                                        <img class="mb-3 mb-xl-4 pb-xl-2" src="styles/images/work/3.jpg" alt="">
                                        <figcaption>
                                            <ul class="noneStyle ul-green-dot lh165">
                                                <li class="mb-1">案場內部分區域，在植生復育上已有初步成果，而各區域也因地理環境、生態豐富</li>
                                                <li class="mb-1">水土保持性等考量而選用不同的植生項目</li>
                                                <li class="mb-1">針對區域範圍，恢復植生覆蓋，並達到強化水土保持保護效果。</li>
                                            </ul>
                                        </figcaption>
                                    </figure>
                                </div>
                                <div class="col-12 col-md-6">
                                    <figure class="d-table mx-auto my-md-3 my-xl-5 py-3" data-aos="fade-up">
                                        <img class="mb-3 mb-xl-4 pb-xl-2" src="styles/images/work/4.jpg" alt="">
                                        <figcaption>
                                            <ul class="noneStyle ul-green-dot lh165">
                                                <li class="mb-1">案場內部分區域，在植生復育上已有初步成果，而各區域也因地理環境、生態豐富</li>
                                                <li class="mb-1">水土保持性等考量而選用不同的植生項目</li>
                            ...
                            <div>
                                <h2 class="font-24 font-weight-bold les1 mb-3 mb-md-4" data-aos="fade-up">力行植生復育 多元物種豐富在地生態，永續潔能與環境友善，強化水土保持保護效果，永續潔能與環境友善</h2>
                                <p data-aos="fade-up">近年面臨極端氣候之威脅及能源耗竭之挑戰，積極發展綠能並推動能源永續已屬當務之急，新能源技術應用成為帶動產業發展的主要動力，並帶動相關產業蓬勃發展，行政院亦推動能源轉型計畫政策，全力發展低碳綠能的再生能源，目標總發電量占比達20%為目標。近年面臨極端氣候之威脅及能源耗竭之挑戰，積極發展綠能並推動能源永續已屬當務之急，新能源技術應用成為帶動產業發展的主要動力，並帶動相關產業蓬勃發展，行政院亦推動能源轉型計畫政策，全力發展低碳綠能的再生能源，目標總發電量占比達20%為目標。</p>
                            </div>
                        </div>
                    </div>
